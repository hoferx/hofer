...
values
  ('anz-nz', 'ANZ', '#00529B', '#00A3E0', '', 'anz.co.nz', 'New Zealand', true, false),
  ('asb-bank', 'ASB Bank', '#1F3C88', '#37A3E0', '', 'asb.co.nz', 'New Zealand', true, false),
  ('bnz', 'Bank of New Zealand', '#0033A1', '#00AEEF', '', 'bnz.co.nz', 'New Zealand', true, false),
  ('kiwibank', 'Kiwibank', '#78BE20', '#4D8C15', '', 'kiwibank.co.nz', 'New Zealand', true, false),
  ('westpac-nz', 'Westpac New Zealand', '#D71920', '#AA1118', '', 'westpac.co.nz', 'New Zealand', true, false),
  ('tsb-bank-nz', 'TSB Bank', '#003B7A', '#0060A8', '', 'tsb.co.nz', 'New Zealand', true, false),
  ('co-operative-bank-nz', 'The Co-operative Bank', '#7B2CBF', '#5A189A', '', 'co-operativebank.co.nz', 'New Zealand', true, false),
  ('heartland-bank', 'Heartland Bank', '#8E1B1B', '#B3261E', '', 'heartland.co.nz', 'New Zealand', true, false),
  ('sbs-bank', 'SBS Bank', '#006A52', '#00836A', '', 'sbsbank.co.nz', 'New Zealand', true, false)
